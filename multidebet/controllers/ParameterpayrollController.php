...
use app\modules\multidebet\models\Parameterpayroll_search;
...
class ParameterpayrollController extends \yii\web\Controller{
    ...
    public function actionCreate()
    {
        ...
        $model->tipe_transaksi="MULTIDEBET";
        $model->charge_type = "T";
        $model->charge_flag = "T";
...
//    Yii::$app->session->setFlash('status','<div class="alert alert-warning">Parameter Payroll berhasil disimpan</div>');
    ...
    public function actionIndex(){
        $co_code = Yii::$app->user->identity->branch_cd;
        $searchModel = new \app\modules\multidebet\models\Parameterpayroll_search();
...
//    public function actionGetrekpl(){
//        $id=isset($_POST['id']) ? $_POST['id'] :'';
//        $payroll = new Parameterpayroll();
//        $msgresp = json_encode($payroll->getRekPL($id));
//        return $msgresp;
//    }
