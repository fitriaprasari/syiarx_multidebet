...
?>
        ...
        <div class="acctno">
            <?php
//            $form->field($model, '', ['template' => "{label}<div class='col-sm-4'>{input}{error}{hint}</div>"])->dropDownList(
//                ['' => 'Pilih',
...
//                ['style' => 'height: auto; width: auto;']);
        ...
        <!--flag biaya-->
        <?=
         $form->field($model,'rekening_biaya',['inputTemplate'=>'<div class="">{input}</div>','template'=>'{label}'
             . '<div class="row">'
...
$this->registerJs(
        ...
        . ''
        //REKENING PL
        . '$("#'.Html::getInputId($model,'rekening_biaya').'").change('
        . 'function(e){'
        . 'e.preventDefault();'
        . 'var isPL = $("#'.Html::getInputId($model,'rekening_biaya').'").val();'
        . 'if(isPL == "Y"){'
        . '         $("#'.Html::getInputId($model,'acctno').'").val("PL52081");'
        . '         $("#'.Html::getInputId($model,'acctname').'").val("PENDAPATAN JASA-PAYROLL");'
        . '         $("#'.Html::getInputId($model,'branch_co_code').'").val("ID0010001");'
        . '         var branch_co_code = "ID0010001";'
        . '         $.post("'. Url::toRoute("parameterpayroll/getbranchname") . '", { id: branch_co_code } ).done(function(data){ '
                . '         var obj = JSON.parse(data);'
                . '         if(obj.status == "NA"){'
                . '             $("#'. Html::getInputId($model,'branch_nm'). '").val("");'
        ...
        . '}else{'
        . '$("#'.Html::getInputId($model,'acctname').'").val("");'
        . '$("#'.Html::getInputId($model,'branch_co_code').'").val("");'
        . '$("#'.Html::getInputId($model,'branch_nm').'").val("");'
