...
$this->params['breadcrumbs'][] = ['label' => 'Daftar Upload', 'url' => ['daftarupload']];
$this->title = $nama_file_upload;
$this->params['breadcrumbs'][] = 'Detail Data Upload Payroll Multidebet';
?>
...
//            ['attribute'=> 'nip','label'=>'NIP'],
            ...
            [
                'attribute'=>'acctno_cr',
                'label'=> 'No.Rek.Kredit' //dibalik mjd rek.debet
            ],
            [
                'attribute'=>'acctno_db',
                'label'=> 'No.Rek.Debet' //dibalik mjd rek.debet
            ],
            [
                ...
                'buttons' => [
                    ...
                    if($model->status != 'valid'){
                                ...
                                Html::a($url = Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                                    ['/multidebet/uploadpayroll/updatedetaildata?'
                                    .'id='.$model->id
