...
$this->title = 'Daftar Data Upload Payroll Multidebet';
                ...
                'buttons' => [
                    ...
                    'read'=> function($url, $model, $aksi_btn) {
                            if($model->valid_stat == 'ERROR'){
                                ...
                                ['/multidebet/uploadpayroll/detaildata?'
...
//                            ]));
                            ...
                            return Html::a(
                            $url = Html::a('Delete',
                            ['/multidebet/uploadpayroll/deletetemp?kode_parameter='
                             .$model->kode_parameter.'&nama_file_upload='
                             .$model->nama_file_upload],
                            ['class' => 'btn btn-danger', 'data-method'=>'post',
                             'data'  => [ 
                            ...
                            return Html::a(
                            $url = Html::a('Delete',
                            ['/multidebet/uploadpayroll/delete?kode_parameter='
                             .$model->kode_parameter.'&nama_file_upload='
                             .$model->nama_file_upload],
                            ['class' => 'btn btn-danger', 'data-method'=>'post',
                             'data'  => [ 
